...
class OllamaLauncher(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # "Test Ollama" button for debugging
        self.test_ollama_button = QtWidgets.QPushButton("Test Ollama (Debug)")
        self.test_ollama_button.clicked.connect(self.test_ollama_debug)
        self.layout.addWidget(self.test_ollama_button)
